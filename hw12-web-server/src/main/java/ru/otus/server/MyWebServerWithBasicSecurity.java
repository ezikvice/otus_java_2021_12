...
public class MyWebServerWithBasicSecurity extends MyWebServerSimple {
    ...
    public MyWebServerWithBasicSecurity(int port,
                                        LoginService loginService,
                                        DBServiceClient dataTemplate,
                                        Gson gson,
                                        TemplateProcessor templateProcessor) {
        super(port, dataTemplate, gson, templateProcessor);
